...
urlpatterns = [
    ...
    # Managing Product
    path('product-list/<int:pk>/<slug:slug>/',views.ProductListView.as_view(),name='product_list'),
    path('product-detail/<int:id>/<slug:slug>/',views.ProductDetailView,name='product_detail'),
    ...
    # Validating Payment
    path('validate-payment/<int:pk>/',views.ValidatePayment,name='validate_payment'),
