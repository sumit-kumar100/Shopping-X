...
class Categories(models.Model):
    ...
    thumbnail = models.ImageField(upload_to='categories/',null=False,blank=False)
...
class SubCategoriesVariant(models.Model):
    ...
    def __str__(self):
        return self.subcategory.__str__() + ' - ' + self.title
...
class Product(models.Model):
    ...
    id = models.AutoField(primary_key=True)
    subcategoryvariant = models.ForeignKey(SubCategoriesVariant,on_delete=models.CASCADE)
    ...
    color = models.ForeignKey(Color,on_delete=models.CASCADE,null=True,blank=True,default=None)
    size = models.ForeignKey(Size,on_delete=models.CASCADE,null=True,blank=True,default=None)
...
class Payment(models.Model):
    ...
    payment_request_id = models.CharField(max_length=200,unique=True,null=False,blank=False)
    date = models.DateTimeField(auto_now_add=True)